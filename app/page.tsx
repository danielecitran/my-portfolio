...
export default function Home() {
  ...
  useEffect(() => {
    ...
    if (isFirstVisit) {
      ...
      // Animation nach 2s beenden (länger als die CSS-Animation)
            ...
            <div className="grid gap-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                {[1, 2, 3].map((index) => (
                  <div
                    key={index}
                    className="bg-[#f5f5f7] rounded-3xl p-8 animate-pulse"
                  >
  ...
  return (
    <div className="min-h-screen bg-white">
      <Head>
        <title>Daniele Citran – Portfolio</title>
        <meta
          name="description"
          content="Portfolio von Daniele Citran, Informatikmittelschüler an der IMS Hottingen."
        />
      </Head>
