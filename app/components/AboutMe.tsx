                        ...
                        <div className="space-y-3">
                            {[
                                { 
                                    ...
                                    icon: (
                                        <svg viewBox="0 0 24 24" className="w-6 h-6 text-sky-600">
                                            <path fill="currentColor" d="M20,4H4A2,2 0 0,0 2,6V18A2,2 0 0,0 4,20H20A2,2 0 0,0 22,18V6A2,2 0 0,0 20,4M4,6H20V8H4V6M4,18V10H20V18H4M6,12H8V16H6V12M10,12H18V14H10V12M10,15H14V16H10V15Z" />
                                        </svg>
                                    ),
                                ...
                                { 
                                    ...
                                    desc: 'Cross-Platform Entwicklung' 
                                },
                                { 
                                    name: 'Open Source', 
                                    icon: (
