        ...
        <div className="w-full bg-white">
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="text-center mt-16">
                    <Link href="/projects" 
                        className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-sky-400 to-sky-600 text-white rounded-full font-medium transform hover:scale-105 transition-all duration-300 hover:shadow-xl gap-2 relative z-10">
